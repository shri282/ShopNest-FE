        ...
        <Box p={2} paddingTop={6}>
          ...
          <Box className="prod-container" display="flex" gap={4}>
            ...
            <Box className="product-details" flex={1}>
              ...
              <Box mb={3}>
                ...
                <List dense sx={{ pl: 2 }}>
                  <ListItem>
                    <ListItemText primary="Material: High-quality fabric" />
                  </ListItem>
                  <ListItem>
                    <ListItemText primary="Dimensions: 10 x 5 x 3 inches" />
                  </ListItem>
                  <ListItem>
                    <ListItemText primary="Weight: 0.5 kg" />
                  </ListItem>
                  <ListItem>
                    <ListItemText primary="Color: Black" />
                  </ListItem>
                </List>
              </Box>
          ...
          >
            ...
            >
              ...
              <WriteReview
                product={product}
                onReviewSubmit={() => setReviewSubmitted(!reviewSubmitted)}
              />
            </Box>
