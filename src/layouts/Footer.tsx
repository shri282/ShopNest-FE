  ...
  return (
    <Box sx={{ 
        ...
        <Box display={'flex'} flexDirection={'column'} gap={1}>
            <Typography variant='h4' color='brown'>Say Hello!!!</Typography>
            <Typography variant='subtitle2'>Get the lates trends delivered to your inbox!!</Typography>
        ...
        <Box sx={{ 
            ...
            <Box>
                <Typography sx={{ fontWeight: 700, color: 'brown' }}>company</Typography>
                <Box my={2} sx={{ cursor: 'pointer' }}>
            ...
            <Box>
                <Typography sx={{ fontWeight: 700, color: 'brown' }}>social</Typography>
                <Box my={2} sx={{ cursor: 'pointer' }}>
